...
cfg.DATASETS.TRAIN = ("dataset_train_aug1",)
cfg.DATASETS.TEST = ("dataset_train_aug1", "dataset_val_aug1")
...
#cfg.OUTPUT_DIR = "/work/azstaszewska/Models/detectron9"
...
cfg.DATASETS.TEST = ('dataset_train_aug1', 'dataset_val_aug1')  # predictor requires this field to not be empty
...
os.makedirs(Path(output_loc), exist_ok=True)
evaluator = COCOEvaluator("dataset_val_aug1", output_dir=output_loc)
...
'''
val_loader = build_detection_test_loader(cfg, 'dataset_val_aug1')
