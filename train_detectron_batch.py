...
val_data = json.load(open("/home/azstaszewska/Data/Detectron full set/final/val_trim_1.json"))
train_data = json.load(open("/home/azstaszewska/Data/Detectron full set/final/train_trim_1.json"))
...
results = open("/home/azstaszewska/batch_run_results_new.txt", "a")
